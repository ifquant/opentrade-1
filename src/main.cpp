...
uint256 hashGenesisBlock("0x614d6abcf7f1358ee4a3951e04e583f1795ab6fa99303a4253a456bcfac16d68");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // opentrade: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "opentrade Signed Message:\n";
...
{
    // opentrade: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 109840000); // opentrade: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // opentrade: 3.5 days
static const int64 nTargetSpacing = 150; // opentrade: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // opentrade: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // opentrade: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // opentrade: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x894481cab1def1788ed7cf1d3dae996fddd10c3c6afabddbecb0ea017af72580");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "opentrade.system";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("d0082f3371a4180abf0fb334d340996c64e09bc6bedf591a57c7bd5728a1a6654acec5810824fe6dfd56a4634f80f909d2a865e3026cea3d7470008df21b7f937e") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1460849580;
        block.nBits    = 504365644;
        block.nNonce   = 764431582;

        if (fTestNet)
        {
            block.nTime    = 1460849580;
            block.nNonce   = 3247305555;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xcb37ea064a960c9f3ffe3a23afd126b9604e4f59c25319a17d080b2620957082"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // opentrade: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("opentradeMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("opentradeMiner : ProcessBlock, block not accepted");
    }
